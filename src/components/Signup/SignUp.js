...
function SignUp() {
  ...
  return (
    <div className=' card row' style={{height:"150%",width:"100%"}}>
    <div class=" row 12">
      <div class=" col-sm-6 col-md-6 col-lg-6 py-6 mt-5">
        <img src={leftImge}
         className="Img_size" />
      </div>
      <div className="Auth-form-container1 col-sm-6 col-md-6 col-lg-6">
        <form className="Auth-form1">
          <div className="Auth-form-content1">
            <h3 className="Auth-form-title1">Sign Up</h3>
            <div className="text-center">
              Already registered?
              <Link to='/signin'><a href="#"><b style={{color:"#EFAF4E"}}>Sign in</b></a>
              </Link>
            </div>
